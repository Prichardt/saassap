...
$mDateFlex= $_POST['mdateflex'];

$storageRequired = $_POST['storageRequired'];
if($storageRequired == ""){
$storageRequired = "No";
}
$assembeRequired = $_POST['assembeRequired'];
if($assembeRequired == ""){
$assembeRequired = "No";
}
$packagingRequired = $_POST['packagingRequired'];
...
$content .= '</table>';
$content .= "</div>";
$content .= $storageRequired. " I require storage service before/after move.<br/>";
$content .= $assembeRequired. " I require assembling service.<br/>";
$content .= $packagingRequired. " I require packaging service.<br/>";
$content .= "Referred By:" .$referrer. "<br/>";
$content .= "Heard of Leopard movers from:" .$hearus. "<br/>";
